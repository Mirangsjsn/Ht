...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "add_group":  
        await query.edit_message_text("➕ لطفاً آیدی عددی گروه را ارسال کنید (مثال: -1001511872349):")  
        ...
        await query.edit_message_text("🧪 لطفاً آیدی عددی گروه برای تست ارسال کنید (مثال: -1001511872349):")  
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if mode == "add_group_id":  
        # قبول کردن هم اعداد ساده و هم آیدی گروه که با -100 شروع میشه
        ...
        for gid in group_chat_ids:  
            try:  
                ...
                success += 1  
                await asyncio.sleep(0.1)  # تاخیر بین ارسال پیام‌ها
            except Exception as e:  
